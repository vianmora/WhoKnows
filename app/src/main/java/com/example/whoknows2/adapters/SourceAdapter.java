...
public class SourceAdapter extends ArrayAdapter<Source> implements SpinnerAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.activity_flux, parent, false);
        }

        TextView mTitle_tv = (TextView) convertView.findViewById(R.id.activity_flux_source);
